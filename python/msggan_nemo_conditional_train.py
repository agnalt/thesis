""" This module contains the code that was used for training the conditional GANs
on the Foraminifera dataset. """
...
def train_model():
    ...
    train_images = load_images(
        "python/data/nemo/sediment_train", IMG_HEIGHT, IMG_WIDTH)
    ...
    model = MsgProGan(
        channels=CHANNELS, folder="python/saved_models/msggan_nemo_sediment", use_eql=True, depth=DEPTH)
    ...
    try:
        ...
        model.train(train_dataset, 1200)
